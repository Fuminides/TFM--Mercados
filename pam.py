...
def kmedoids(data, k, distance = 3):
	'''
	...
	pre_cost, medoids = totalCost(data, distance, medoids_idx)
		...
		for m in medoids:
			for item in medoids[m]:
				...
				if item != m:
					...
					tmp_cost, tmp_medoids = totalCost(data, distance, medoids_idx)
